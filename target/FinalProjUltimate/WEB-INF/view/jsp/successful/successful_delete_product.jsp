...
<div class="container">
    <div class="jumbotron mt-3">
        <h1><fmt:message key="successful_delete_product.product.successfully.deleted.text"/></h1>
        <p class="lead"></p>
        <a class="btn btn-lg btn-primary" href="${Path.PRODUCT_CATALOG}"
           role="button"><fmt:message key="successful_delete_product.to.product.catalog.text"/></a>
    </div>
</div>
