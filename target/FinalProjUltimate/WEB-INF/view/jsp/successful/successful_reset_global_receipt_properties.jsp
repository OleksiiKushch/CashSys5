...
<html>
<head>
    <title>CashSys.reset.global.receipt.properties.success</title>
...
<div class="container">
    <div class="jumbotron mt-3">
        <h1><fmt:message key="successful_reset_global_receipt_properties.global.receipt.properties.successfully.reset.text"/></h1>
        <p class="lead"></p>
        <a class="btn btn-lg btn-primary" href="${Path.SET_GLOBAL_RECEIPT_PROPERTIES}"
           role="button"><fmt:message key="successful_reset_global_receipt_properties.to.set.global.receipt.properties.page.text"/></a>
        <a class="btn btn-lg btn-primary" href="${Path.MAIN}"
           role="button"><fmt:message key="successful_reset_global_receipt_properties.to.main.page.text"/></a>
    </div>
</div>
