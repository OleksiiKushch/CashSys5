...
public abstract class LogMessage {
    ...
    // product
    public static final String FIND_PRODUCTS_WITH_PAGINATION_FROM_DATABASE_LOG_MSG = "Error while select rows (products) from the receipt table with pagination";
    public static final String FIND_PRODUCTS_BY_QUERY_FROM_DATABASE_LOG_MSG = "Error while select rows (products) from the receipt table by query";
    ...
    public static final String FIND_RECEIPTS_WITH_PAGINATION_FROM_DATABASE_LOG_MSG = "Error while select rows (receipts) from the receipt table with pagination";
    public static final String GET_GLOBAL_RECEIPT_PROPERTIES_FROM_DATABASE_LOG_MSG = "Error while concrete row from the global receipt properties table";
    public static final String SET_GLOBAL_RECEIPT_PROPERTIES_TO_DATABASE_LOG_MSG = "Error while inserting row to the global receipt properties table";
    public static final String RESET_GLOBAL_RECEIPT_PROPERTIES_IN_DATABASE_LOG_MSG = "Error while deleting row in the global receipt properties table";
    ...
    public static final String FIND_BEST_CASHIERS_BY_COUNT_RECEIPT_FROM_DATABASE_LOG_MSG = "Error while get rows (cashiers, count receipts) sorting by count receipt";
