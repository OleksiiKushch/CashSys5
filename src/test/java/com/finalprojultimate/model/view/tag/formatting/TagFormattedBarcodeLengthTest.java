...
public class TagFormattedBarcodeLengthTest {
    ...
    public void doStartTag() throws IOException {
        ...
        TagFormattedBarcodeLength tag = new TagFormattedBarcodeLength();
        tag.setPageContext(pageContext);
        tag.setBarcode("48230895003314823089500331");
        tag.doStartTag();

        verify(jspWriter, times(1)).println("4823089500331...");
